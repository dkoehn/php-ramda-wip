...
namespace PHPRambda\Internal {
  ...
  function _arity($n, $fn)
  {
    switch ($n) {
      ...
      case 1: return function($a) use ($fn) { return $fn($a); };
      case 2: return function($a, $b) use ($fn) { return $fn($a, $b); };
      case 3: return function($a, $b, $c) use ($fn) { return $fn($a, $b, $c); };
      case 4: return function($a, $b, $c, $d) use ($fn) { return $fn($a, $b, $c, $d); };
      case 5: return function($a, $b, $c, $d, $e) use ($fn) { return $fn($a, $b, $c, $d, $e); };
      case 6: return function($a, $b, $c, $d, $e, $f) use ($fn) { return $fn($a, $b, $c, $d, $e, $f); };
      case 7: return function($a, $b, $c, $d, $e, $f, $g) use ($fn) { return $fn($a, $b, $c, $d, $e, $f, $g); };
      case 8: return function($a, $b, $c, $d, $e, $f, $g, $h) use ($fn) { return $fn($a, $b, $c, $d, $e, $f, $g, $h); };
      case 9: return function($a, $b, $c, $d, $e, $f, $g, $h, $i) use ($fn) { return $fn($a, $b, $c, $d, $e, $f, $g, $h, $i); };
      case 10: return function($a, $b, $c, $d, $e, $f, $g, $h, $i, $j) use ($fn) { return $fn($a, $b, $c, $d, $e, $f, $g, $h, $i, $j); };
      default: throw new \RuntimeException('First argument to _arity must be a non-negative integer no greater than ten');
    }
  }
  ...
  function _slice($args, $from = null, $to = null)
  {
    switch (func_num_args()) {
      case 1: return _slice($args, 0, count($args));
      case 2: return _slice($args, $from, count($args));
      default: return array_slice($args, $from, $to);
    }
  }
}
